...
export declare const TENANT_PMS_KEYS: readonly ["pms_provider", "pms_fail_mode", "pms_unknown_mode", "pms_session_timeout_minutes", "pms_db_host", "pms_db_port", "pms_db_user", "pms_db_password", "pms_db_database", "pms_sql_table", "pms_sql_room_column", "pms_sql_name_column", "pms_sql_tc_column", "pms_sql_passport_column", "pms_sql_checkin_column", "pms_sql_checkout_column", "pms_sql_status_column", "pms_sql_inhouse_value", "pms_sql_external_ref_column", "pms_api_url", "pms_api_key"];
export declare const MAX_SESSION_TIMEOUT_MINUTES = 1440;
export declare const PMS_QUERY_TIMEOUT_MS = 5000;
export declare const CIRCUIT_FAILURE_THRESHOLD = 5;
export declare const CIRCUIT_DISABLE_DURATION_MS: number;
